...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ActivityFilter_activityAction com.example.sound_store:activityAction}</code></td><td>Action used for activity launch.</td></tr>
     * <tr><td><code>{@link #ActivityFilter_activityName com.example.sound_store:activityName}</code></td><td>Component name of the primary activity in the split.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:activityAction
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:activityName
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #ActivityRule_alwaysExpand com.example.sound_store:alwaysExpand}</code></td><td>Whether the activity should always be expanded on launch.</td></tr>
     * </table>
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.sound_store:alwaysExpand
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #Capability_queryPatterns com.example.sound_store:queryPatterns}</code></td><td>Resource reference to the string array of query patterns for a custom capability.</td></tr>
     * <tr><td><code>{@link #Capability_shortcutMatchRequired com.example.sound_store:shortcutMatchRequired}</code></td><td>Indicates whether a parameter in a capability template can only contain a matched
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.sound_store:queryPatterns
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.sound_store:shortcutMatchRequired
     */
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha com.example.sound_store:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.example.sound_store:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority com.example.sound_store:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts com.example.sound_store:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy com.example.sound_store:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout com.example.sound_store:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage com.example.sound_store:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery com.example.sound_store:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderSystemFontFamily com.example.sound_store:fontProviderSystemFontFamily}</code></td><td>Provides the system font family name to check before downloading the font.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.sound_store:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name com.example.sound_store:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name com.example.sound_store:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:fontProviderQuery
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:fontProviderSystemFontFamily
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font com.example.sound_store:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle com.example.sound_store:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings com.example.sound_store:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight com.example.sound_store:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex com.example.sound_store:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.sound_store:font
     */
     ...
     * </table>
     *
     * @attr name com.example.sound_store:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.sound_store:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.sound_store:ttcIndex
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPairFilter_primaryActivityName com.example.sound_store:primaryActivityName}</code></td><td>Component name of the primary activity in the split.</td></tr>
     * <tr><td><code>{@link #SplitPairFilter_secondaryActivityAction com.example.sound_store:secondaryActivityAction}</code></td><td>Action used for secondary activity launch.</td></tr>
     * <tr><td><code>{@link #SplitPairFilter_secondaryActivityName com.example.sound_store:secondaryActivityName}</code></td><td>Component name of the secondary activity in the split.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:primaryActivityName
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:secondaryActivityAction
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:secondaryActivityName
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPairRule_clearTop com.example.sound_store:clearTop}</code></td><td>If there is an existing split with the same primary container, indicates whether the
     * existing secondary container on top and all activities in it should be destroyed when a new
     * split is created using this rule.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_finishPrimaryWithSecondary com.example.sound_store:finishPrimaryWithSecondary}</code></td><td>When all activities are finished in the secondary container, the activity in the
     * primary container that created the split should also be finished.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_finishSecondaryWithPrimary com.example.sound_store:finishSecondaryWithPrimary}</code></td><td>When all activities are finished in the primary container, the activities in the
     * secondary container in the split should also be finished.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitLayoutDirection com.example.sound_store:splitLayoutDirection}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitMinSmallestWidth com.example.sound_store:splitMinSmallestWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitMinWidth com.example.sound_store:splitMinWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitRatio com.example.sound_store:splitRatio}</code></td><td></td></tr>
     * </table>
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.sound_store:clearTop
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.sound_store:finishPrimaryWithSecondary
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.sound_store:finishSecondaryWithPrimary
     */
    public static final int SplitPairRule_finishSecondaryWithPrimary=2;
    /**
     * <p>This symbol is the offset where the {@link com.example.sound_store.R.attr#splitLayoutDirection}
     ...
     * </table>
     *
     * @attr name com.example.sound_store:splitLayoutDirection
     */
    public static final int SplitPairRule_splitLayoutDirection=3;
    /**
     * <p>This symbol is the offset where the {@link com.example.sound_store.R.attr#splitMinSmallestWidth}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name com.example.sound_store:splitMinSmallestWidth
     */
    public static final int SplitPairRule_splitMinSmallestWidth=4;
    /**
     * <p>This symbol is the offset where the {@link com.example.sound_store.R.attr#splitMinWidth}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name com.example.sound_store:splitMinWidth
     */
    public static final int SplitPairRule_splitMinWidth=5;
    /**
     * <p>This symbol is the offset where the {@link com.example.sound_store.R.attr#splitRatio}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.example.sound_store:splitRatio
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_placeholderActivityName com.example.sound_store:placeholderActivityName}</code></td><td>Component name of the placeholder activity in the split.</td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitLayoutDirection com.example.sound_store:splitLayoutDirection}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitMinSmallestWidth com.example.sound_store:splitMinSmallestWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitMinWidth com.example.sound_store:splitMinWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitRatio com.example.sound_store:splitRatio}</code></td><td></td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.sound_store:placeholderActivityName
     */
